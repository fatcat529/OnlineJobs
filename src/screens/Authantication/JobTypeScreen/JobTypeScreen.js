      ...
      <View>
        <ScrollView
          ...
          <View style={JobTypeStyle.container}>
            <View style={JobTypeStyle.MainViewAllContent}>
              <Spacing space={SH(50)} />
              <Text style={JobTypeStyle.TextStyles}>{t("What_Type_Of_Job_You_Looking_For")}</Text>
              <Spacing space={SH(50)} />
              <View>
                <FlatList
                  data={Checkboxs}
        ...
        <View style={JobTypeStyle.ButtonPostionSet}>
